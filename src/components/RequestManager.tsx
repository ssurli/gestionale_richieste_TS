...
export interface PianoAcquistiItem {
  ...
  email?: string | null;
  unita_operativa?: string | null;
  reparto_presidio?: string | null;
  descrizione?: string | null;
  quantita?: number | null;
  caratteristiche_tecniche?: string | null;
  procedura_diagnosi?: string | null;
  prestazioni_annue?: string | number | null;
  motivo_acquisizione?: string | null;
  come_svolta_attualmente?: string | null;
  sostituisce_aggiorna?: string | null;
  tecnologie_stessa_tipologia?: string | null;
  specificare_quali?: string | null;
  miglioramenti_attesi?: string | null;
  risorse_necessarie?: string | null;
  tipologia_acquisto?: string | null;
  costo_iva_esclusa?: string | null;
  percentuale_iva?: number | null;
  importo_iva_inclusa?: string | null;
  durata_mesi_contratto?: number | null;
  progetto_finalizzato?: string | null;
  ...
  ordine_si_no?: string | null;
  anno_ordine?: number | null;
  numero_ordine?: string | null;
  ordine_riferimenti?: string | null;
  note?: string | null;
  tipologia_trasduttori?: string | null;
}
