...
export interface PianoAcquistiItem {
  ...
  unita_operativa?: string | number | null;
  reparto_presidio?: string | number | null;
  descrizione?: string | number | null;
  quantita?: number | null;
  caratteristiche_tecniche?: string | number | null;
  procedura_diagnosi?: string | number | null;
  prestazioni_annue?: string | number | null;
  motivo_acquisizione?: string | number | null;
  come_svolta_attualmente?: string | number | null;
  sostituisce_aggiorna?: string | number | null;
  tecnologie_stessa_tipologia?: string | number | null;
  specificare_quali?: string | number | null;
  miglioramenti_attesi?: string | number | null;
  risorse_necessarie?: string | number | null;
  tipologia_acquisto?: string | number | null;
  costo_iva_esclusa?: string | number | null;
  percentuale_iva?: number | null;
  importo_iva_inclusa?: string | number | null;
  durata_mesi_contratto?: number | null;
  progetto_finalizzato?: string | number | null;
  codice_progetto?: string | number | null;
  direttore?: string | number | null;
  data_richiesta?: string | number | null;
  autorizzazione?: string | number | null;
  copertura?: string | number | null;
  contratto?: string | number | null;
  ordine_si_no?: string | number | null;
  anno_ordine?: number | null;
  numero_ordine?: string | number | null;
  ordine_riferimenti?: string | number | null;
  note?: string | number | null;
  tipologia_trasduttori?: string | number | null;
}
